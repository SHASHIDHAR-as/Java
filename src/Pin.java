...
public class Pin extends JFrame implements ActionListener{
    ...
    Pin(String pin){
        ...
        l1.setBounds(235,280,700,25);
        l4.add(l1);
        
        l2.setBounds(180,320,150,25);
        l4.add(l2);
        
        l3.setBounds(180,350,200,25);
        l4.add(l3);
        
        t1.setBounds(350,320,180,25);
        l4.add(t1);
        
        t2.setBounds(350,350,180,25);
        l4.add(t2);
        
        b1.setBounds(390,390,150,25);
        l4.add(b1);
        
        b2.setBounds(390,420,150,25);
        l4.add(b2);
